...
async function main() {
    ...
    const order4 = await prisma.order.create({
        data: {
            ...
            items: {
                create: [
                    { productId: products[3].id, vendorId: vendor1.id, requestedQty: 80, status: client_1.ItemStatus.PENDING },
                    { productId: products[4].id, vendorId: vendor1.id, requestedQty: 60, status: client_1.ItemStatus.PENDING },
                    { productId: products[9].id, vendorId: vendor1.id, requestedQty: 40, status: client_1.ItemStatus.PENDING },
                ],
            },
        },
    });
    const order5 = await prisma.order.create({
        data: {
            ...
            items: {
                create: [
                    { productId: products[8].id, vendorId: vendor2.id, requestedQty: 150, status: client_1.ItemStatus.PENDING },
                    { productId: products[11].id, vendorId: vendor2.id, requestedQty: 45, status: client_1.ItemStatus.PENDING },
                    { productId: products[14].id, vendorId: vendor2.id, requestedQty: 12, status: client_1.ItemStatus.PENDING },
                ],
            },
        },
    });
    ...
    console.log(`Users: admin(${admin.phone}); vendors ${vendor1.phone}, ${vendor2.phone}, ${vendor3.phone}, ${vendor4.phone}; traders ${trader1.phone}, ${trader2.phone}, ${trader3.phone}; customers ${customer1.phone}, ${customer2.phone}, ${customer3.phone}, ${customer4.phone}, ${customer5.phone}`);
