      ...
      <div className="mx-auto max-w-4xl px-4 py-4 space-y-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-full bg-gray-100 px-4 py-2.5 text-sm placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-primary-500/20"
          />
                ...
                {editingId === brand.id ? (
                  <>
                    <input
                      ...
                      className="flex-1 rounded-full bg-gray-100 px-4 py-2 text-sm placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-primary-500/20"
                      autoFocus
                    />
                    <button
                      onClick={submitEdit}
